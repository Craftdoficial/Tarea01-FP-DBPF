...
public class Media_Positivos {
    public static void main(String[] args) {
      ...
      System.out.println("El programa no toma en cuenta el número negativo, porque ese es su mecanismo de pare. así que siempre tomará solo los valores positivos ");
    }
  }